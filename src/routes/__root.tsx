  ...
  head: () => ({
    meta: [
      ...
      { title: "Sanningskompassen, The Truth Compass" },
      {
        name: "description",
        content:
          "Learn to spot political manipulation by writing it yourself. Built at Järvaveckan 2026.",
      },
      { name: "theme-color", content: "#0F2A4D" },
      { property: "og:title", content: "Sanningskompassen, The Truth Compass" },
      {
        property: "og:description",
        content: "Inoculation training for young voters in Järva.",
      },
