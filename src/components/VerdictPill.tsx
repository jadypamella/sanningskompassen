...
const STYLES: Record<Verdict, { bg: string; text: string; label: string; Icon: typeof CheckCircle2 }> = {
  true: { bg: "bg-truth", text: "text-paper", label: "TRUE", Icon: CheckCircle2 },
  uncertain: { bg: "bg-gold", text: "text-navy", label: "UNCERTAIN", Icon: HelpCircle },
  false: { bg: "bg-lie", text: "text-paper", label: "FALSE", Icon: XCircle },
};
